        ...
        <div class="max-w-2xl lg:max-w-5xl mx-auto">
            <div class="text-center">
                <h1 class="text-3xl font-bold text-gray-800 sm:text-4xl dark:text-white">
                    Be <span class="text-red-500">ONE</span> of Us!
                </h1>
                <p class="mt-1 text-gray-600 dark:text-neutral-400">
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptatum perspiciatis corrupti expedita, facilis rerum harum!
                </p>
            </div>
            ...
            <div>
                <div class="max-w-5xl px-4 xl:px-0 py-10 mx-auto">
                    <div class="border border-neutral-200 dark:border-neutral-800 rounded-xl">
                        <div class="p-4 lg:p-8 bg-linear-to-bl darK:from-neutral-800 dark:via-neutral-900 dark:to-neutral-950 rounded-xl">
                            <div class="grid grid-cols-1 sm:grid-cols-3 items-center gap-y-20 gap-x-12">
                                ...
                                <div class="relative text-center first:before:hidden before:absolute before:-top-full sm:before:top-1/2 before:start-1/2 sm:before:-start-6 before:w-px before:h-20 before:bg-neutral-800 before:rotate-[60deg] sm:before:rotate-12 before:transform sm:before:-translate-y-1/2 before:-translate-x-1/2 sm:before:-translate-x-0 before:mt-3.5 sm:before:mt-0">
                                    <svg class="shrink-0 size-6 sm:size-8 text-red-600 mx-auto" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m11 17 2 2a1 1 0 1 0 3-3"/><path d="m14 14 2.5 2.5a1 1 0 1 0 3-3l-3.88-3.88a3 3 0 0 0-4.24 0l-.88.88a1 1 0 1 1-3-3l2.81-2.81a5.79 5.79 0 0 1 7.06-.87l.47.28a2 2 0 0 0 1.42.25L21 4"/><path d="m21 3 1 11h-2"/><path d="M3 3 2 14l6.5 6.5a1 1 0 1 0 3-3"/><path d="M3 4h8"/></svg>
                                    <div class="mt-3 sm:mt-5">
                                        <h3 class="text-lg sm:text-3xl font-semibold text-gray-800 dark:text-white">2,000+</h3>
                                        <p class="mt-1 text-sm sm:text-base text-neutral-400">Volunteers</p>
                                    </div>
                                </div>
                                <!-- End Stats -->
                                ...
                                <div class="flex justify-center items-center -space-x-5">
                                    <img class="relative z-2 shrink-0 size-8 rounded-full border-3 border-red-600" src="https://images.unsplash.com/photo-1601935111741-ae98b2b230b0?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=320&h=320&q=80" alt="Avatar">
                                    <img class="relative z-1 shrink-0 size-8 rounded-full border-3 border-red-600 -mt-7" src="https://images.unsplash.com/photo-1570654639102-bdd95efeca7a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=320&h=320&q=80" alt="Avatar">
                                    <img class="relative shrink-0 size-8 rounded-full border-3 border-red-600" src="https://images.unsplash.com/photo-1679412330254-90cb240038c5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2.5&w=320&h=320&q=80" alt="Avatar">
                                </div>
                                <div class="mt-3 sm:mt-5">
                                    <h3 class="text-lg sm:text-3xl font-semibold text-gray-800 dark:text-white">100%</h3>
                                    <p class="mt-1 text-sm sm:text-base text-neutral-400">Optimistic Volunteers</p>
                                </div>
                                </div>
                                <!-- End Stats -->
                                ...
                                <div class="mt-3 sm:mt-5">
                                    <h3 class="text-lg sm:text-3xl font-semibold text-gray-800 dark:text-white">1000+</h3>
                                    <p class="mt-1 text-sm sm:text-base text-neutral-400">Peoples saved</p>
                                </div>
                                </div>
                                <!-- End Stats -->
                            </div>
            ...
            <div class=" grid items-center lg:grid-cols-2 gap-6 lg:gap-16">
                ...
                <form wire:submit.prevent="submit">
                    ...
                    <select
                        ...
                        <option selected="">{{ __('Select Organization') }}</option>
                    ...
                    <div class="relative">
                        ...
                        not-placeholder-shown:pb-2
                        autofill:pt-6
                        autofill:pb-2" placeholder="Notes" data-hs-textarea-auto-height></textarea>
                        <label for="notes" class="absolute top-0 start-0 p-3 sm:p-4 h-full text-neutral-400 text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent peer-disabled:opacity-50 peer-disabled:pointer-events-none
                        peer-focus:text-xs
                        peer-focus:-translate-y-1.5
                        peer-focus:text-neutral-400
                        peer-not-placeholder-shown:text-xs
                        peer-not-placeholder-shown:-translate-y-1.5
                        peer-not-placeholder-shown:text-neutral-400">Tell us about yourself</label>
                    </div>
                    <!-- End Textarea -->
                    </div>
                    ...
                    <p class="mt-5">
                        <button wire:loading.attr="disabled" wire:loading.class="opacity-50"  wire:click="submit" type="submit" class="group inline-flex items-center gap-x-2 py-3 px-4 bg-red-600 font-medium text-sm text-neutral-200 rounded-lg focus:outline-hidden cursor-pointer">
                        {{ __('Submit') }}
